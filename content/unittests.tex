...
Anfangs waren all unsere Unittests in dem \keyword{absGDX-framework} Projekt. Deshalb war dieses Projekt von jUnit abhängig und jUnit ist seinerseits von der Hamcrest Bibliothek abhängig\footnote{\url{http://hamcrest.org/JavaHamcrest/}}. 
