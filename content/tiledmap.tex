...
In den meisten Fällen ist nicht die ganze Map sichtbar da der aktuelle MapScaleResolver die Tiles groß genug macht um das gesamte Display auszufüllen. Deshalb gibt es im \keyword{GameLayer} einen \ti{MapOffset}. Dieser gibt an wie weit die Karte in X und Y Richtung verschoben ist.
