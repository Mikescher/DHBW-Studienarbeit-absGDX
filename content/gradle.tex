...
Gradle unterstützt viele verschiedene Repositories in welcher nach fehlenden Bibliotheken gesucht werden kann, standardmäßig wird jedoch die \ti{Maven Central Repository} \cite{MCENTRAL} benutzt.
...
\quickfigure{Gradle Dependency Graph absGDX}{dependency-graph-gradle.png}{1.0} %TODO update me
