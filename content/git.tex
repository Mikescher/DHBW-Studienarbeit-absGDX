Da wir an diesem Projekt zu zweit programmieren, war es notwendig den Code zentral auf einem Server speichern, so dass wir beide Zugriff darauf haben.
...
\quickfigure{Screenshot SmartGit}{smartgit}{0.7}
