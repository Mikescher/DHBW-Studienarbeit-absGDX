...
\quickfigure{absGDX Metrics}{metrics}{1.0}
...
\quickfigure{absGDX Test Coverage}{coverage}{1.0}

Wie in Abb. 8 zu sehen ist, haben wir keine hundert prozentige Testabdeckung. Trotzdem sind wichtige und fehleranfällige Pakete wie \ti{collisiondetection}, \ti{math} oder \ti{mapscaleresolver} fast vollständig abgedeckt.
