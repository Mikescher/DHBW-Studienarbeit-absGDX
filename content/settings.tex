...
\begin{itemize}
\item \keyword{ConstantBooleanProperty:} Dies ist eine BooleanProperty die nicht mehr veränderlich ist. Dies ist nützlich für zur Compile-zeit festgelegte Werte (wie ob der Debugmode überhaupt möglich ist)
...
%TODO Es gibt noch mehr Properties - seit neustem
\end{itemize}
