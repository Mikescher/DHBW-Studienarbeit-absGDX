...
\begin{itemize}
\item \keyword{ConstantBooleanProperty:} Dies ist eine BooleanProperty die nicht mehr veränderlich ist. Dies ist nützlich für zur Compile-zeit festgelegte Werte (wie ob debugging möglich ist)
